...
const { getCategories, getT1Categories, newCategory, newHobsonCategory, deleteCategory, saveAttr, categoriesForProductList, updateCategoryDisplay, getSubcategoriesT2 } = require("../controllers/categoryController")
...
router.post("/admin/hobson", newHobsonCategory)
