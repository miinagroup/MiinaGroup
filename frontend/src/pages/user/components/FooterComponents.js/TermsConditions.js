    ...
    return (
        <div className="container"><br />
            ...
            <ul className="terms-ul">
                ...
                <li>If we provide social media features with certain content, you make take such actions as are enabled by such features.</li>
                <p>You must not:</p>
            ...
            <h5 className="terms">USER CONTRIBUTIONS</h5>
            <p>The Website may contain interactive features (collectively, "Interactive Services") that allow users to post, submit, publish, display or transmit to other users or other persons (hereinafter, "post") content or materials (collectively, "User Contributions") on or through the Website.</p>
        ...
        <ul className="terms-ul">
            ...
            <ul className="terms-ul">
                ...
                <p>Without limiting the foregoing, you acknowledge and agree that, to the extent permitted by law:</p>
                <li>We will fully cooperate with any law enforcement authorities or court order requesting or directing us to disclose the identity or other information of anyone posting any materials on or through the Website.</li>
                <li>You waive and hold harmless the Company and its related bodies corporate, licensees and service providers from any claims resulting from any action taken by any of the foregoing parties during or as a result of its investigations and from any actions taken as a consequence of investigations by either such parties or law enforcement authorities.</li>
            </ul>
            <p>However, we do not undertake to review all material before it is posted on the Website, and cannot ensure prompt removal of objectionable material after it has been posted. Accordingly, we assume no liability for any action or inaction regarding transmissions, communications or content provided by any user or third party. We have no liability or responsibility to anyone for performance or nonperformance of the activities described in this section.</p>
            <h5 className="terms">CONTENT STANDARDS</h5>
            ...
            <h5 className="terms">CHANGES TO THE WEBSITE</h5>
            ...
            <h5 className="terms">INFORMATION ABOUT YOU AND YOUR VISITS TO THE WEBSITE</h5>
            ...
            <h5 className="terms">LINKING TO THE WEBSITE AND SOCIAL MEDIA FEATURES</h5>
            ...
            <p>We may disable all or any social media features and any links at any time without notice in our discretion.  The social media may be independent of this Company.</p>

            <h5 className="terms">LINKS FROM THE WEBSITE</h5>
            ...
            <h5 className="terms">GEOGRAPHIC RESTRICTIONS</h5>
            <p>We provide this Website for use only by persons located in the Australia. We make no claims that the Website or any of its content is accessible or appropriate outside of Australia. Access to the Website may not be legal by certain persons or in certain countries. If you access the Website from outside Australia, you do so on your own initiative and are responsible for compliance with local laws</p>

            <h5 className="terms">DISCLAIMER OF WARRANTIES</h5>
            ...
            <p>The Company hereby disclaims all warranties of any kind, whether express or implied, statutory or otherwise, including but not limited to any warranties of acceptable quality, non-infringement and fitness for particular purpose.</p>
            <p>The foregoing does not affect any warranties which cannot be excluded or limited under applicable law.</p>

            <h5 className="terms">LIMITATION ON LIABILITY</h5>
            <p>In no event will the Company, its related bodies corporate or their licensors, service providers, employees, agents, officers or directors be liable for damages of any kind, under any legal theory, arising out of or in connection with your use, or inability to use, the Website, any websites linked to it, any content on the Website or such other websites or any services or items obtained through the Website or such other websites, including any direct, indirect, special, incidental, consequential or punitive loss or damages, including but not limited to, personal injury, pain and suffering, emotional distress, loss of revenue, loss of profits, loss of business or anticipated savings, loss of use, loss of goodwill, loss of data, and whether caused by tort (including negligence), breach of contract or otherwise, even if foreseeable.</p>
            <p>The foregoing does not affect any liability which cannot be excluded or limited under applicable law.</p>
            <p>If section 23 of the Australian Consumer Law applies to any provision of this Agreement, any such provision(s) will be void to the extent they are unfair within the meaning of section 24 of the Australian Consumer Law</p>

            <h5 className="terms">INDEMNIFICATION</h5>
            <p>You agree to defend, indemnify and hold harmless the Company, its related bodies corporate, licensors and service providers, and its and their respective officers, directors, employees, contractors, agents, licensors, suppliers, successors and assigns from and against any claims, liabilities, damages, judgments, awards, losses, costs, expenses or fees (including reasonable legal fees) arising out of or relating to your violation of these Terms of Use or your use (or the use of your employees or persons under your control) of the Website, including, but not limited to, your User Contributions, any use of the Website's content, services and products other than as expressly authorized in these Terms of Use or your use of any information obtained from the Website.</p>

            <h5 className="terms">GOVERNING LAW AND JURISDICTION</h5>
            <p>All matters relating to the Website and these Terms of Use and any dispute or claim arising therefrom or related thereto (in each case, including non-contractual disputes or claims), shall be governed by and construed in accordance with the laws of New South Wales without giving effect to any choice or conflict of law provision or rule. Any legal suit, action or proceeding arising out of or related to this Agreement or the Application shall be instituted non-exclusively in the courts of New South Wales.</p>

            <h5 className="terms">LIMITATION ON TIME TO FILE CLAIMS</h5>
            ...
            <h5 className="terms">WAIVER AND SEVERABILITY</h5>
