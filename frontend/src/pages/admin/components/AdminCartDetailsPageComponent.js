          ...
          cartProducts: [
            {
              ...
              slrRandallsSku: item.cartProducts[0].slrRandallsSku,
              slrDaisyMilanoSku: item.cartProducts[0].slrDaisyMilanoSku,
              slrMaxwellsSku: item.cartProducts[0].slrMaxwellsSku,
              fmlCGOSku: item.cartProducts[0].fmlCGOSku,
              fmlTMHCSku: item.cartProducts[0].fmlTMHCSku,
              evnMungariSku: item.cartProducts[0].evnMungariSku,
