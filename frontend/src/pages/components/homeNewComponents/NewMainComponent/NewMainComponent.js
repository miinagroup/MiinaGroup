...
const NewMainComponent = () => {
    ...
    <div className={styles.homeNew}>
      ...
      <video autoPlay loop muted playsInline preload="auto" className={`${styles.bgVid} mobile`}><source src={"https://ctladmin.b-cdn.net/video/Vertical.CTL.main%20(1).mp4"} type="video/mp4" /></video>
    </div> 
  </div>
}
