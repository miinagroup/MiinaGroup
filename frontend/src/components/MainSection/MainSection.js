...
const MainSection = () => {
 ...
 return <div className={styles.main}>
    <img src="/svg/FamilyEmblemWhite.svg" alt="Family Emblem White" className={styles.FamilyEmblemWhite} />
            ...
            >
              {subcategories[selectedCategory].sort().map((subcategory, index) => (
                    <SwiperSlide key={index}>
                       <a href={`/product-list?categoryName=${selectedCategory}&subCategoryName=${subcategory}`}>
