        ...
        <div className={styles.aboutWrapper}>
            <div className={styles.aboutInfo} id="about">
                ...
                <p className={styles.text}>
                    Founded in 2021, Miina Group was created to capitalize on opportunities within the Robe River Kuruma Native Title lands and Rio Tinto Operations at Mesa A and Mesa J and other operating Proponents in the region.  <br /> <br />
                    ...
                    Miina's future plans include staged development, starting in 2023/24, with a focus on business planning with industry engagement, and the responsible execution of mining and other sectors supply operations. The company's strong foundation in mining knowledge and plant operations ensures its commitment to delivering reliable and culturally respectful services on Kuruma country and beyond.
                </p>
            </div>
